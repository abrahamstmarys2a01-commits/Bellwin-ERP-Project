...
const AddRemittance = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:5000/api/remittances', formData);
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-4 shrink-0 flex justify-end gap-3">
          ...
          <button
            ...
            type="submit"
            className="px-6 py-1.5 text-[15px] bg-erp-green text-white font-medium rounded-none hover:bg-green-700 transition-colors shadow-sm inline-flex items-center justify-center gap-1.5 disabled:opacity-50 w-auto tracking-wide"
          >
